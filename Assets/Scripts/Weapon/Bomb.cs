...
public class Bomb : MonoBehaviour
{
	...
	private ParticleSystem  m_ExplosionFX;		// Reference to the particle system of the explosion effect.

    private bool            m_Exploded = false;

	void Awake ()
	{
        m_ExplosionFX = GameObject.FindGameObjectWithTag("ExplosionFX").GetComponent<ParticleSystem>();
    ...
    {
        if (col.gameObject.tag == "Enemy" && !m_Exploded)
            Explode();
    }
	...
	public void Explode()
	{
        ...
        m_ExplosionFX.transform.position = transform.position;
        m_ExplosionFX.Play();
